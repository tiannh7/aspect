...
#include <aspect/postprocess/visualization/surface_geoid.h>
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      ...
      SurfaceGeoid ()
        :
        DataPostprocessorScalar<dim> ("surface_geoid",
      ...
      template <int dim>
      std::list<std::string>
      SurfaceGeoid<dim>::required_other_postprocessors() const
      {
        return {"geoid"};
      }
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
      ASPECT_REGISTER_VISUALIZATION_POSTPROCESSOR(SurfaceGeoid,
                                                  "surface geoid",
                                                  "Visualization for the surface geoid solution. The geoid is given "
