  ...
  namespace BoundaryTraction
  {
      ...
      public ::aspect::SimulatorAccess<dim>
    {
      public:
        ...
        std::pair<double,double>
        applied_surface_potential_coefficient(const unsigned int degree,
                                              const unsigned int order) const;
      ...
      private:
        ...
        AppliedPotential applied_potential;
        ...
        // Externally applied potential, Phi/g, evaluated at the surface and
        // CMB. This is used for tidal/rotational forcing and is separate from
        ...
        std::vector<double> applied_cmb_potential_sin_coeffs;
