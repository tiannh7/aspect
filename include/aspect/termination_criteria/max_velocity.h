...
#ifndef _aspect_termination_criteria_max_velocity_h
#define _aspect_termination_criteria_max_velocity_h
...
namespace aspect
{
  namespace TerminationCriteria
  {
    ...
    /**
     * A class that terminates the simulation when a specified maximum velocity
     * criterion is met, based on a user-defined function expression.
     *
     * @ingroup TerminationCriteria
     */
    template <int dim>
    class MaxVelocity : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
         ...
         * maximum velocity and other variables.
         */
         ...
         */
        double compute_max_velocity() const;
    };
