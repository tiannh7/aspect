...
#ifndef _aspect_termination_criteria_timestep_h
#define _aspect_termination_criteria_timestep_h
...
namespace aspect
{
  namespace TerminationCriteria
  {
    ...
    /**
     * A class that terminates the simulation when a specified timestep
     * criterion is met, based on a user-defined function expression.
     *
     * @ingroup TerminationCriteria
     */
    template <int dim>
    class Timestep : public Interface<dim>, public SimulatorAccess<dim>
    {
      public:
        /**
