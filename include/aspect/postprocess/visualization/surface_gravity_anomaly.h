...
#ifndef _aspect_postprocess_visualization_surface_gravity_anomaly_h
#define _aspect_postprocess_visualization_surface_gravity_anomaly_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * that represents the surface gravity anomaly. This quantity, strictly
       * speaking, only makes sense at the surface of the domain. Thus, the
       * value is set to zero on all boundary faces except the top surface.
       *
       * The member functions are all implementations of those declared in the
       * base class. See there for their meaning.
       */
      template <int dim>
      class SurfaceGravityAnomaly
