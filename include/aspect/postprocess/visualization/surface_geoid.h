...
#ifndef _aspect_postprocess_visualization_surface_geoid_h
#define _aspect_postprocess_visualization_surface_geoid_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * that represents the surface geoid topography. This quantity, strictly
