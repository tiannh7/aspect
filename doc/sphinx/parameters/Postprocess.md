...
&lsquo;mesh geometry statistics&rsquo;: A postprocessor that computes statistics about the geometry of active mesh cells. In particular, it reports the minimal and maximal cell diameter, shortest edge length, and longest edge length, as well as the minimal, average, and maximal cell aspect ratio. The aspect ratio is defined as the ratio between the longest and shortest edge lengths of each cell.
